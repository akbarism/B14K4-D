function usernameValidity(username) {
    const regUsername = /^[a-z][a-zA-Z0-9_]{4,12}$/ //username di awali huruf kecil,tidka boleh menggunakan simbol spesial, minimal 5 sampai 12 chara
...
function passwordValidity(password) {
    ...
    const number = password.match(/[0-9]/g) //regex untuk angka
...
usernameValidity("FIONA_mareta")//untuk memvalidasi username
